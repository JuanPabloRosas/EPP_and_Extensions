...
def EPP_scheduling():
   ...
   for h in range(0,len(I.students)):
      for a in I.actividades():
         _x[a.a,a.s,h] = model.addVar(0.0, 1.0, vtype = GRB.BINARY ,name='_x[%s,%s,%s]' % (a.a,a.s,h))
   ...
   for h in range(0,len(I.students)):
      for a in I.actividades():
         _ct[a.a,a.s,h] = model.addVar(vtype = GRB.INTEGER ,name='_ct[%s,%s,%s]' % (a.a,a.s,h))
   ...
   for h in range(0,len(I.students)):
      for sub in I.subtemas() :
         ...
         model.addConstr(gp.quicksum(int(a.v) * _x[a.a,a.s,h] for a in I.actividades() if a.s == sub) >= I.kmin,"Kmin_%s_%s_%s" % (a.a,a.s,h))
         #	Score menor a kmax por subtema
         model.addConstr(gp.quicksum(int(a.v) * _x[a.a,a.s,h] for a in I.actividades() if a.s == sub) <= I.kmax,"Kmax_%s_%s_%s" % (a.a,a.s,h))
   ...
   for h in range(0,len(I.students)):
      for a in I.actividades():
         if(a.o == '1'):
            model.addConstr(_x[a.a,a.s,h] == 1, "mandatory_%s_%s_%s" % (a.a,a.s,h))
   #"""   
	#-------------------------------------------------------------------------------------
   for h in range(0,len(I.students)):
      for a in I.actividades():
         #  Completation time
         model.addConstr(_ct[a.a,a.s,h] == _st[a.a,a.s,h] + (a.d * (1 + I.students[h].stress[_st[a.a,a.s,h]] ))  * _x[a.a,a.s,h], "ct_%s_%s_%s" % (a.a,a.s,h))
         #  Start time
         model.addConstr(_st[a.a,a.s,h] <= M - a.d  * _x[a.a,a.s,h], "st_%s_%s_%s" % (a.a,a.s,h))
         #  Due dates      
      ...
      for a in I.actividades():
         for a2 in I.actividades():
            if(a.a!=a2.a):
               ...
               model.addConstr(_ct[a.a,a.s,h] <= _st[a2.a,a2.s,h] + M*(3 - _p[a.a,a2.a,h] - _x[a.a,a.s,h] - _x[a2.a,a2.s,h]) , "seq_%s_%s_%s" % (a.a,a2.a,h))
               model.addConstr(_ct[a2.a,a2.s,h] <= _st[a.a,a.s,h] + M*(2 + _p[a.a,a2.a,h] - _x[a.a,a.s,h] - _x[a2.a,a2.s,h]), "seq_%s_%s_%s" % (a2.a,a.a,h))
         ...
         for h2 in range(0,len(I.students)):
            for a2 in I.actividades():
               if((int(a.r) != 0) and (int(a2.r) != 0) and (a.r==a2.r)):
                  model.addConstr(_ct[a.a,a.s,h] <= _st[a2.a,a2.s,h2] + M*(3 - _r[a.a,a2.a,h,h2] - _x[a.a,a.s,h] - _x[a2.a,a2.s,h2]) , "rec_%s_%s" % (a.a,a2.a))
                  model.addConstr(_ct[a2.a,a2.s,h2] <= _st[a.a,a.s,h] + M*(2 + _r[a.a,a2.a,h,h2] - _x[a.a,a.s,h] - _x[a2.a,a2.s,h2]), "rec_%s_%s" % (a2.a,a.a))
   ...
   obj = gp.quicksum((a.d * (1 + I.students[h].stress[_st[a.a,a.s,h]] )) * _x[a.a,a.s,h] for a in I.actividades() for h in range(0,len(I.students)))
